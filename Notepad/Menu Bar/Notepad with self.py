...
class fonts:
    def __init__(self, master, **kwargs):
        ...
        self.frame = LabelFrame(self.master, text='Choose Text Font', font=('Time', 16, 'bold italic'))
        self.frame.pack()
        self.scrollbar = Scrollbar(self.frame)

        self.font_list = Listbox(self.frame,
                                 width=37,
                                 height=25,
        ...
        E = ttk.Entry(self.frame, width=40)
        E.pack()
        ...
        self.frame2 = LabelFrame(self.master, text='Choose Fond Size',font=('Time', 16, 'bold italic'))
        self.frame2.pack()

        l = Label(self.frame2, text='Size', font=('Time', 14, 'bold'))
        l.pack(side=LEFT)

        self.size_input = Spinbox(self.frame2, from_=5, to=99, width=10, font=('Time', 14, 'bold'))
        self.size_input.pack(side=LEFT)

        b = ttk.Button(self.master, text='Save font and size')
        b.pack(side=BOTTOM)

        # current_selection_index = self.available_fonts.index(self.frame.font_family)
