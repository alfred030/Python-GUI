...
def submit():
    ...
    T = scr.selection_get()
    print(T)
    messagebox.showinfo(title='Languages', message='This is the portion you select: ' + T)
...
class entry:
    def __init__(self, master):
        ...
        ttk.Button(master, text='Print the selection', command=submit).pack()
        ttk.Button(master, text='Clear', command=Clear).pack()
