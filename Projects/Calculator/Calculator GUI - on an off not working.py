...
class Application(Frame):
    def __init__(self, master): # to initillaze this window
        ...
        self.master.iconbitmap(r'm1.ico')
        ...
        self.label=Label(self.master,text="scientific calculator", bg = '#b5b5b5')
        self.label.grid(row=0, column=0,sticky="NWNESWSE", columnspan=4)

        '''
        self.label=Button(self.master,
                         #text=" (exp = power, deg = degree, and e = exponentiel)",
                         #font=(font_1 ,10, style),
                         bg = '#b5b5b5',
                         relief=relief_1,
                         
                         )
        self.label.grid(row=12, column=0,sticky="NWNESWSE", columnspan=4)    
        '''
